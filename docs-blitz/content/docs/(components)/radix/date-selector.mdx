...
} from "@/components/blitz-ui/r-date-selector"
```
...
<ComponentPreview styleName="radix-nova" name="p-date-selector-2" />

### With Dialog

<ComponentPreview styleName="radix-nova" name="p-date-selector-3" />

### With i18n Support

<ComponentPreview styleName="radix-nova" name="p-date-selector-4" />
