...
<ComponentPreview name="p-data-grid-1" className="**:[.preview]:h-auto" align="start" />
...
```bash
npx shadcn@latest add @blitz-ui/data-grid
```
...
```bash
npm install @base-ui/react @tanstack/react-table
```
...
<ComponentSource name="data-grid" title="components/blitz-ui/data-grid/data-grid.tsx" />

<ComponentSource
  name="data-grid-table"
  title="@components/blitz-ui/data-grid/data-grid-table.tsx"
/>

<ComponentSource
  name="data-grid-pagination"
  title="components/blitz-ui/data-grid/data-grid-pagination.tsx"
/>

<ComponentSource
  name="data-grid-column-header"
  title="components/blitz-ui/data-grid/data-grid-column-header.tsx"
/>

<ComponentSource
  name="data-grid-column-filter"
  title="components/blitz-ui/data-grid/data-grid-column-filter.tsx"
/>

<ComponentSource
  name="data-grid-column-visibility"
  title="components/blitz-ui/data-grid/data-grid-column-visibility.tsx"
/>

<ComponentSource
  name="data-grid-table-dnd"
  title="components/blitz-ui/data-grid/data-grid-table-dnd.tsx"
/>

<ComponentSource
  name="data-grid-table-dnd-rows"
  title="components/blitz-ui/data-grid/data-grid-table-dnd-rows.tsx"
/>
...
<ComponentPreview name="p-data-grid-2" className="**:[.preview]:h-auto" align="start" />

### Dense Table

<ComponentPreview name="p-data-grid-3" className="**:[.preview]:h-auto" align="start" />

### Light Table

<ComponentPreview name="p-data-grid-4" className="**:[.preview]:h-auto" align="start" />

### Striped Table

<ComponentPreview name="p-data-grid-5" className="**:[.preview]:h-auto" align="start" />

### Auto Width

<ComponentPreview name="p-data-grid-6" className="**:[.preview]:h-auto" align="start" />

### Row Selection

<ComponentPreview name="p-data-grid-7" className="**:[.preview]:h-auto" align="start" />

### Expandable Row

<ComponentPreview name="p-data-grid-8" className="**:[.preview]:h-auto" align="start" />

### Sub Data Grid

<ComponentPreview name="p-data-grid-9" className="**:[.preview]:h-auto" align="start" />

### Column Icons

<ComponentPreview name="p-data-grid-10" className="**:[.preview]:h-auto" align="start" />

### Sortable Columns

<ComponentPreview name="p-data-grid-11" className="**:[.preview]:h-auto" align="start" />

### Movable Columns

<ComponentPreview name="p-data-grid-12" className="**:[.preview]:h-auto" align="start" />

### Draggable Columns

<ComponentPreview name="p-data-grid-13" className="**:[.preview]:h-auto" align="start" />

### Draggable Rows

<ComponentPreview name="p-data-grid-14" className="**:[.preview]:h-auto" align="start" />

### Resizable Columns

<ComponentPreview name="p-data-grid-15" className="**:[.preview]:h-auto" align="start" />

### Pinnable Columns

<ComponentPreview name="p-data-grid-16" className="**:[.preview]:h-auto" align="start" />

### Sticky Header

<ComponentPreview name="p-data-grid-17" className="**:[.preview]:h-auto" align="start" />

### Column Controls

<ComponentPreview name="p-data-grid-18" className="**:[.preview]:h-auto" align="start" />

### Card Container

<ComponentPreview name="p-data-grid-19" className="**:[.preview]:h-auto" align="start" />

### Column Visibility

<ComponentPreview name="p-data-grid-20" className="**:[.preview]:h-auto" align="start" />

### Loading Skeleton

<ComponentPreview name="p-data-grid-21" className="**:[.preview]:h-auto" align="start" />

### CRUD

<ComponentPreview name="p-data-grid-22" className="**:[.preview]:h-auto" align="start" />
