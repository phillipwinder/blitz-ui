...
<ComponentPreview name="p-kanban-1" className="**:[.preview]:h-auto" align="start" />
...
```bash
npx shadcn@latest add @blitz-ui/kanban
```
...
<ComponentSource name="kanban" title="components/blitz-ui/kanban.tsx" />
...
<ComponentPreview name="p-kanban-2" className="**:[.preview]:h-auto" align="start" />
