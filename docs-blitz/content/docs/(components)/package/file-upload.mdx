...
<ComponentPreview name="p-file-upload-1" />
...
```bash
npx shadcn@latest add @blitz-ui/use-file-upload
```
...
<ComponentPreview name="p-file-upload-2" />

### Compact Upload

<ComponentPreview name="p-file-upload-3" />

### Gallery Upload

<ComponentPreview name="p-file-upload-4" className="[&_.preview]:h-auto [&_.preview>*]:w-full" />

### Progress Upload

<ComponentPreview name="p-file-upload-5" className="[&_.preview]:h-auto [&_.preview>*]:w-full" />

### Table Upload

<ComponentPreview name="p-file-upload-6" className="[&_.preview]:h-auto [&_.preview>*]:w-full" />

### Image Upload

<ComponentPreview name="p-file-upload-7" className="[&_.preview]:h-auto [&_.preview>*]:w-full" />

### Sortable Upload

<ComponentPreview name="p-file-upload-8" className="[&_.preview]:h-auto [&_.preview>*]:w-full" />
