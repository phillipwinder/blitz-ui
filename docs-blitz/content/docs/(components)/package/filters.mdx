...
<ComponentPreview name="p-filters-1" align="start" className="**:[.preview]:h-auto" />
...
```bash
npx shadcn@latest add @blitz-ui/filters
```
...
<ComponentSource name="filters" title="components/blitz-ui/filters.tsx" />
...
```tsx
import { createFilter, Filters, type Filter, type FilterFieldConfig } from "@blitz-ui/react/filters"
```
...
<ComponentPreview name="p-filters-2" align="start" />

### Trigger Button

<ComponentPreview name="p-filters-3" align="start" />

### Small Size

<ComponentPreview name="p-filters-4" align="start" />

### Large Size

<ComponentPreview name="p-filters-5" align="start" />

### Custom Controls

<ComponentPreview name="p-filters-6" align="start" />

### Data Grid

<ComponentPreview name="p-filters-7" className="**:[.preview]:h-auto" align="start" />

### Nuqs

<ComponentPreview name="p-filters-8" className="**:[.preview]:h-auto" align="start" />

### With i18n Support

<ComponentPreview name="p-filters-9" align="start" />
