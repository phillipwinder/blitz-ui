...
} from "@/components/blitz-ui/date-selector"
```
...
<ComponentPreview styleName="base-nova" name="p-date-selector-2" />

### With Dialog

<ComponentPreview styleName="base-nova" name="p-date-selector-3" />

### With i18n Support

<ComponentPreview styleName="base-nova" name="p-date-selector-4" />
