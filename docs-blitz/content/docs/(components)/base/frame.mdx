...
<ComponentPreview styleName="base-nova" name="p-frame-2" />

### With Stacked Panels

<ComponentPreview styleName="base-nova" name="p-frame-3" />

### With Dense Panels

<ComponentPreview styleName="base-nova" name="p-frame-4" />

### Without Outer Border

<ComponentPreview styleName="base-nova" name="p-frame-6" />
