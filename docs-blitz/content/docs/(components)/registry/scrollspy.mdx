...
```bash
npx shadcn@latest add @blitz-ui/scrollspy
```
...
<ComponentSource styleName="base-nove" name="scrollspy" title="components/blitz-ui/scrollspy.tsx" />
...
```tsx
import { Scrollspy } from "@/components/blitz-ui/scrollspy"
```
