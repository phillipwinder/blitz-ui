...
<ComponentPreview styleName="base-nove" name="p-stepper-1" />
...
```bash
npx shadcn@latest add @blitz-ui/stepper
```
...
<ComponentSource styleName="base-nove" name="stepper" title="components/blitz-ui/stepper.tsx" />
...
import {
  ...
  StepperSeparator,
  StepperTrigger,
} from "@/components/blitz-ui/stepper"
```
...
<ComponentPreview styleName="base-nove" name="p-stepper-2" />

### Indicators

<ComponentPreview styleName="base-nove" name="p-stepper-3" />

### Controlled

<ComponentPreview styleName="base-nove" name="p-stepper-4" />

### Progress

<ComponentPreview styleName="base-nove" name="p-stepper-5" />

### Title

<ComponentPreview styleName="base-nove" name="p-stepper-6" />

### Title & Bar

<ComponentPreview styleName="base-nove" name="p-stepper-7" />

### Title & Status

<ComponentPreview styleName="base-nove" name="p-stepper-8" />

### Title & Description

<ComponentPreview styleName="base-nove" name="p-stepper-9" />

### Inline Title

<ComponentPreview styleName="base-nove" name="p-stepper-10" />

### Inline Title & Description

<ComponentPreview styleName="base-nove" name="p-stepper-11" />

### Vertical

<ComponentPreview styleName="base-nove" name="p-stepper-12" />

### Vertical Title

<ComponentPreview styleName="base-nove" name="p-stepper-13" />

### Vertical Title & Description

<ComponentPreview styleName="base-nove" name="p-stepper-14" />
