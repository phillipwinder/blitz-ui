...
```bash component
npx shadcn@latest add @blitz-ui/alert
```
...
<ComponentSource styleName="base-nove" name="alert" title="components/blitz-ui/alert.tsx" />
...
```tsx
import { Alert, AlertAction, AlertDescription, AlertTitle } from "@/components/blitz-ui/alert"
```
...
<ComponentPreview styleName="base-nove" name="p-alert-2" />

### With Action Buttons

<ComponentPreview styleName="base-nove" name="p-alert-3" />

### With Extended Message

<ComponentPreview styleName="base-nove" name="p-alert-4" />

### With Title and Action Buttons

<ComponentPreview styleName="base-nove" name="p-alert-10" />

### With Description and Action Buttons

<ComponentPreview styleName="base-nove" name="p-alert-11" />

### Info Alert

<ComponentPreview styleName="base-nove" name="p-alert-5" />

### Success Alert

<ComponentPreview styleName="base-nove" name="p-alert-6" />

### Warning Alert

<ComponentPreview styleName="base-nove" name="p-alert-7" />

### Destructive Alert

<ComponentPreview styleName="base-nove" name="p-alert-8" />

### Invert Alert

<ComponentPreview styleName="base-nove" name="p-alert-9" />
