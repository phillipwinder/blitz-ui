...
<ComponentSource name="frame" title="components/blitz-ui/frame.tsx" />
...
<ComponentPreview name="p-frame-2" />
...
<ComponentPreview name="p-frame-6" />

### Custom Spacing

<ComponentPreview name="p-frame-7" className="**:[.preview]:h-auto" />

### Custom Radius

<ComponentPreview name="p-frame-8" className="**:[.preview]:h-auto" />
