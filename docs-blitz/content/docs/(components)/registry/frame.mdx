...
<ComponentPreview name="p-frame-1" description="A frame with a header, content, and footer" />
...
```bash
npx shadcn@latest add @blitz-ui/frame
```
...
<ComponentSource styleName="base-nove" name="frame" title="components/blitz-ui/frame.tsx" />
...
import {
  ...
  FramePanel,
  FrameTitle,
} from "@/components/blitz-ui/frame"
```
...
<ComponentPreview styleName="base-nove" name="p-frame-2" />

### With Stacked Panels

<ComponentPreview styleName="base-nove" name="p-frame-3" />

### With Dense Panels

<ComponentPreview styleName="base-nove" name="p-frame-4" />

### Without Outer Border

<ComponentPreview styleName="base-nove" name="p-frame-6" />

### Custom Spacing

<ComponentPreview styleName="base-nove" name="p-frame-7" className="**:[.preview]:h-auto" />

### Custom Radius

<ComponentPreview styleName="base-nove" name="p-frame-8" className="**:[.preview]:h-auto" />
