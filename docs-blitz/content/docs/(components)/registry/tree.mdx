...
<ComponentPreview name="p-tree-1" className="**:[.preview]:h-auto" />
...
<ComponentSource name="tree" title="components/blitz-ui/tree.tsx" />
...
<ComponentPreview name="p-tree-2" className="**:[.preview]:h-auto" />

### With Icon

<ComponentPreview name="p-tree-3" className="**:[.preview]:h-auto" />

### With Plus and Minus Icons

<ComponentPreview name="p-tree-4" className="**:[.preview]:h-auto" />
