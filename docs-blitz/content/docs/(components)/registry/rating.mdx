...
<ComponentPreview styleName="base-nove" name="p-rating-1" />
...
<ComponentSource styleName="base-nove" name="rating" title="components/blitz-ui/rating.tsx" />
...
```tsx
import { Rating } from "@/components/blitz-ui/rating"
```
...
<ComponentPreview styleName="base-nove" name="p-rating-2" />

### Show Value

<ComponentPreview styleName="base-nove" name="p-rating-3" />

### Editable

<ComponentPreview styleName="base-nove" name="p-rating-4" />

### Size

<ComponentPreview styleName="base-nove" name="p-rating-5" />
