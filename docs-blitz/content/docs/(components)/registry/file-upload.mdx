...
<ComponentSource styleName="base-nove" name="use-file-upload" title="hooks/use-file-upload.ts" />
...
<ComponentPreview styleName="base-nove" name="p-file-upload-2" />

### Compact Upload

<ComponentPreview styleName="base-nove" name="p-file-upload-3" />
