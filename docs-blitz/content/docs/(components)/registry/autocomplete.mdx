...
```bash
npx shadcn@latest add @blitz-ui/autocomplete
```
...
<ComponentSource name="autocomplete" title="components/blitz-ui/autocomplete.tsx" />
...
import {
  ...
  AutocompleteItem,
  AutocompleteList,
} from "@/components/blitz-ui/autocomplete"
```
