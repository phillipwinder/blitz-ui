...
<ComponentPreview name="p-date-selector-1" align="start" className="**:[.preview]:h-auto!" />
...
```bash
npx shadcn@latest add @blitz-ui/r-date-selector
```
...
<ComponentSource
  styleName="base-nove"
  name="date-selector"
  title="components/blitz-ui/date-selector.tsx"
/>
...
```tsx
import { DateSelector, type DateSelectorValue } from "@/components/blitz-ui/r-date-selector"
```
...
<ComponentPreview styleName="base-nove" name="p-date-selector-2" />

### With Dialog

<ComponentPreview styleName="base-nove" name="p-date-selector-3" />

### With i18n Support

<ComponentPreview styleName="base-nove" name="p-date-selector-4" />
